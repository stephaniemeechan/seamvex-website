...
- **Invoices:** Documenso sign webhook → **DRAFT** invoice (free-text line descriptions; **not** Xero Item codes). Portal **reads** invoice status/amount due on order and contact pages (`accounting.invoices.read`).
